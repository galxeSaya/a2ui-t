...
export class TVChartElement extends HTMLElement {
  ...
  attributeChangedCallback(name: string, _oldValue: string, newValue: string) {
    if (name === 'data-path') this._dataPath = newValue
    else if (name === 'surface-id') this._surfaceId = newValue
    this.render()
  }
...
if (!customElements.get('tv-chart')) {
  customElements.define('tv-chart', TVChartElement)
}
